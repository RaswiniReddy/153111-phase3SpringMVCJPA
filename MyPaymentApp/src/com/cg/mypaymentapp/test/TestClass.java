...
public class TestClass {
	...
	public void testCreateAccount() {
		service.createAccount(new Customer(null, null, null));
	}

	@Test
	public void testCreateAccount2() {
		Customer cust = new Customer("Raswini", "8019413949", new Wallet(
				new BigDecimal(7000)));
		cust = service.createAccount(cust);
	...
	public void testCreateAccount3() {
		...
		cust = service.createAccount(new Customer("Kavya", "9900112213", new Wallet(new BigDecimal(7000))));
		assertEquals("9900112213", cust.getMobileNo());
	}

	@Test(expected = InvalidInputException.class)
	public void testCreateAccount4() {
		service.createAccount(new Customer("raswini", "8019413948", new Wallet(new BigDecimal("092"))));
	}
	...
	public void testName() {
		service.createAccount(new Customer("kavya", "9900112213", new Wallet(new BigDecimal(7000))));
	}

	@Test(expected = InvalidInputException.class)
	public void testMobileNumber() {
		service.createAccount(new Customer("Kavya", "990011221", new Wallet(new BigDecimal(7000))));
	}
